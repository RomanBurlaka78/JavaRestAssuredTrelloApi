...
public class DeleteAllBoards extends BaseService {
    ...
    public List getAllTheBoardsId(List list) {
        Response response = apiClient.get(MembersPath.MEMBERS_BASE_PATH + "me/" + BoardsPath.BOARDS_BASE_PATH, requestSpecification);
        list = apiClient.get(MembersPath.MEMBERS_BASE_PATH + "me/" + BoardsPath.BOARDS_BASE_PATH, requestSpecification).jsonPath().getList("id");
        return list;
    }
