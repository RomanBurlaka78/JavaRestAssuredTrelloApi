...
public class BoardSteps {
    ...
    public Response deleteBoard(String boardId) {
        ...
        return ApiClient.getInstance().delete(PathParameters.BOARD_BASE_PATH + boardId, requestSpecification);
    }

    @Step("Get Board: id board = {boardId}")
    public Response getBoard(String boardId) {

        return apiClient.get(PathParameters.BOARD_BASE_PATH + boardId, requestSpecification);
    }
    ...
    public Response getAField(String boardId, String fieldName) {
        ...
        return apiClient.get(PathParameters.BOARD_BASE_PATH +boardId + fieldName, requestSpecification);
    }

    @Step("Get all actions existed on a board")
    public Response getActions(String boardId, String actions) {

        return apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + actions, requestSpecification);
    }

    @Step("Get checklists presented on a board")
    public Response getChecklists(String boardId, String checklistsEndPoint) {
        return apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + checklistsEndPoint, requestSpecification);
    }

    @Step("Get cards presented on a board")
    public Response getCards(String boardId, String cardsEndPoint) {

        return apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + cardsEndPoint, requestSpecification);
    }
    ...
    public Response getFilteredCards(String boardId, String filtereCardsEndPoint, String filterName) {
        ...
        return apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + filtereCardsEndPoint + filterName, requestSpecification);
    }
    ...
    public Response getCustomFieldsForABoard(String boardId, String customFieldsEndPoint) {
        ...
        return apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + customFieldsEndPoint, requestSpecification);
    }

    @Step("Get lists presented on a board")
    public Response getListsOfABoard(String boardId, String listsEndPoint) {

        return apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + listsEndPoint, requestSpecification);
    }

    public Response getSpecificListOfABoard(String boardId, String listsEndPoint, String filter) {

        return apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + listsEndPoint + filter, requestSpecification);
    }

    public Response getMembersOfABoard(String boardId, String membersEndPoint) {

        return apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + membersEndPoint, requestSpecification);
    }
    ...
    public Response getBoardStarsOnBoard(String boardId, String boardStarsEnPoint) {
        return apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + "/boardStars", requestSpecification);
    }

    @Step("Get memberships on a Board: id board = {boardId}")
    public Response getMembershipsOnBoard(String boardId) {
        return apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + "/memberships", requestSpecification);
    }
    ...
    public Response removeMemberFromBoard(String boardId, String memberId) {
        ...
        return ApiClient.getInstance().delete(PathParameters.BOARD_BASE_PATH + boardId +
