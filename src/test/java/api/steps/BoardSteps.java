...
public class BoardSteps extends BaseService{
    ...
    public Response deleteABoardFromService(String boardId) {
        ...
        Response response = ApiClient.getInstance().delete(PathParameters.BOARD_BASE_PATH + boardId, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getBoard(String boardId) {
        ...
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH + boardId, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getLabelOnBoard(String boardId) {
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + PathParameters.LABLES_BASE_PATH, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response createListOnBoard(String boardId, String nameForList) {
        ...
        Response response = apiClient.post(PathParameters.BOARD_BASE_PATH + boardId + PathParameters.LISTS_BASE_PATH, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getAField(String boardId, String fieldName) {
        ...
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH +boardId + fieldName, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getActions(String boardId, String actions) {
        ...
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + actions, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getChecklists(String boardId, String checklistsEndPoint) {
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + checklistsEndPoint, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getCards(String boardId, String cardsEndPoint) {
        ...
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + cardsEndPoint, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getFilteredCards(String boardId, String filtereCardsEndPoint, String filterName) {
        ...
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + filtereCardsEndPoint + filterName, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getCustomFieldsForABoard(String boardId, String customFieldsEndPoint) {
        ...
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + customFieldsEndPoint, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getListsOfABoard(String boardId, String listsEndPoint) {
        ...
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + listsEndPoint, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getSpecificListOfABoard(String boardId, String listsEndPoint, String filter) {
        ...
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + listsEndPoint + filter, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getMembersOfABoard(String boardId, String membersEndPoint) {
        ...
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + membersEndPoint, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response putWithSpecification(String boardId, String membersEndPoint) {
        ...
        Response response = apiClient.put(PathParameters.BOARD_BASE_PATH + boardId + membersEndPoint, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getBoardStarsOnBoard(String boardId, String boardStarsEnPoint) {
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + "/boardStars", requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getMembershipsOnBoard(String boardId) {
        ...
        Response response = apiClient.get(PathParameters.BOARD_BASE_PATH + boardId + "/memberships", requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response removeMemberFromBoard(String boardId, String memberId) {
        ...
        Response response = ApiClient.getInstance().delete(PathParameters.BOARD_BASE_PATH + boardId +
