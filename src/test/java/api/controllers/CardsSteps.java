...
//    private final String checklistsEndPoint = "/checklists";
    ...
    public Response getCard(String cardId) {
        ...
        Response response = apiClient.get(CardsPath.CARDS_BASE_PATH + cardId, requestSpecification);
//        initRequestSpecification();
    ...
    public Response updateCard(String cardId, String newCardName) {
        ...
        Response response = apiClient.put(CardsPath.CARDS_BASE_PATH + cardId, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response deleteCard(String cardID) {
        Response response = apiClient.delete(CardsPath.CARDS_BASE_PATH + cardID, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getFieldCard(String cardId) {
        ...
        return apiClient.get(CardsPath.CARDS_BASE_PATH + cardId + PathParameters.CUSTOM_FIELDS_BASE_PATH, requestSpecification);
    }

    @Step("Get actions on card: {cardId}, actions = {actions}")
    public Response getActionsCard(String cardId, String actions) {
        return apiClient.get(CardsPath.CARDS_BASE_PATH + cardId + ActionsPath.ACTIONS_BASE_PATH, requestSpecification);
    }

    @Step("Get actions on card: {cardId}, attachments = {attachments}")
    public Response getAttachmentsCard(String cardId) {
        return apiClient.get(CardsPath.CARDS_BASE_PATH + cardId + PathParameters.ATTACHMENTS_BASE_PATH, requestSpecification);
    }
    ...
    public Response getAnAttachmentOnACard(String cardId, String createdAttachmentId) {
        Response response = apiClient.get(CardsPath.CARDS_BASE_PATH + cardId + PathParameters.attachmentsEndPoint + createdAttachmentId, requestSpecification);
        initRequestSpecification();
        return response;
    }
...
//    }
    ...
    public Response getSpecificAttachmentsCard(String cardId, String field) {
        Response response = apiClient.get(CardsPath.CARDS_BASE_PATH + cardId + PathParameters.ATTACHMENTS_BASE_PATH, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response deleteAttachmentCard(String cardID, String attachmentId) {
        Response response = apiClient.delete(CardsPath.CARDS_BASE_PATH + cardID + PathParameters.ATTACHMENTS_BASE_PATH + "/" + attachmentId, requestSpecification);
        initRequestSpecification();
        return response;
    }
    @Step("Get custom fields on card: {cardId}, field = {field}")
    ...
    public Response getCheckItemsCard(String cardId) {
        Response response = apiClient.get(CardsPath.CARDS_BASE_PATH + cardId +
                PathParameters.checkItemsEndPoint, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getChecklistsCard(String cardId) {
        ...
        Response response = apiClient.get(CardsPath.CARDS_BASE_PATH + cardId + CheckListsPath.checklistsEndPoint, requestSpecification);
        initRequestSpecification();
        return response;
    }
