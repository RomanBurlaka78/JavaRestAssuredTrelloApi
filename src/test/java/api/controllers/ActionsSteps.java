...
public class ActionsSteps extends BaseService {
    ...
    public Response getAnAction(String actiontId) {
        Response response = apiClient.get(ActionsPath.ACTIONS_BASE_PATH + actiontId, requestSpecification);
    ...
    public Response updateACommentOfTheAction(String actiontId, String updatedCommentForAnAction) {
        ...
        Response response = apiClient.put(ActionsPath.ACTIONS_BASE_PATH + actiontId + textEndPoint, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response deleteAnAction(String idOfAnActionToDelete) {
        Response response = apiClient.delete(ActionsPath.ACTIONS_BASE_PATH + idOfAnActionToDelete, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getTheResourceOfAnAction(String idOfAnAction, String resourceEndPoint) {
        Response response = apiClient.get(ActionsPath.ACTIONS_BASE_PATH + idOfAnAction + resourceEndPoint, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getActions_Reactions(String actionId) {
        Response response = apiClient.get(ActionsPath.ACTIONS_BASE_PATH + actionId + reactionsEndPoint, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response createReactionForAction(String actiontId) {
        ...
        Response response = apiClient.post(ActionsPath.ACTIONS_BASE_PATH + actiontId + reactionsEndPoint, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getActionsReaction(String actionIdAfterCreatingACard, String idOfReaction) {
        Response response = apiClient.get(ActionsPath.ACTIONS_BASE_PATH + actionIdAfterCreatingACard +
    ...
    public Response deleteActionsReaction(String actionIdAfterCreatingACard, String idOfReaction) {
        Response response = apiClient.delete(ActionsPath.ACTIONS_BASE_PATH + actionIdAfterCreatingACard +
                reactionsEndPoint + idOfReaction, requestSpecification);
        initRequestSpecification();
        return response;
    }
