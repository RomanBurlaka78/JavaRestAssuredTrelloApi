...
public class MembersSteps extends BaseService {
    ...
    public Response getAMember(String firstMemberId) {
        Response response = apiClient.get(MembersPath.MEMBERS_BASE_PATH + firstMemberId, requestSpecification);
    ...
    public Response updateMember(String memberId) {
        Response response = apiClient.put(MembersPath.MEMBERS_BASE_PATH + memberId, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getMemberActions(String memberId) {
        Response response = apiClient.get(MembersPath.MEMBERS_BASE_PATH + memberId + "/actions", requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getMemberCustomBackgrounds(String memberId) {
        Response response = apiClient.get(MembersPath.MEMBERS_BASE_PATH + memberId + "/boardBackgrounds", requestSpecification);
        initRequestSpecification();
    ...
    public Response getGetBoardBackgroundMember(String memberId, String backgroundId) {
        Response response = apiClient.get(MembersPath.MEMBERS_BASE_PATH + memberId + "/boardBackgrounds/" + backgroundId, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getCreateStarBoard(String memberId, String boardId, String pos) {
        ...
        Response response = apiClient.post(MembersPath.MEMBERS_BASE_PATH + memberId + "/boardStars", requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getBoardStarMember(String memberId, String starId) {
        Response response = apiClient.get(MembersPath.MEMBERS_BASE_PATH + memberId + "/boardStars/" + starId, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response updatePositionBoardStarMember(String memberId, String starId, String pos) {
        requestSpecification.queryParam("pos", pos);
        Response response = apiClient.put(MembersPath.MEMBERS_BASE_PATH + memberId + "/boardStars/" + starId, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response deleteStarBoard(String memberId, String starId) {
        Response response = apiClient.delete(MembersPath.MEMBERS_BASE_PATH + memberId + "/boardStars/" + starId, requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getMemberBoardStars(String memberId) {
        Response response = apiClient.get(MembersPath.MEMBERS_BASE_PATH + memberId + "/boardStars", requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getBoardsMemberBelongs(String memberId) {
        Response response = apiClient.get(MembersPath.MEMBERS_BASE_PATH + memberId + "/boards", requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getBoardsMemberInvited(String memberId) {
        Response response = apiClient.get(MembersPath.MEMBERS_BASE_PATH + memberId + "/boardsInvited", requestSpecification);
        initRequestSpecification();
        return response;
    }
    ...
    public Response getCardsMember(String memberId) {
        Response response = apiClient.get(MembersPath.MEMBERS_BASE_PATH + memberId + "/cards", requestSpecification);
        initRequestSpecification();
        return response;
    }
}
